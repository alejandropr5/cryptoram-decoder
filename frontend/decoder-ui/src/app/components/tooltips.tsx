    ...
    <div className="group relative w-fit">
      ...
      <div className="absolute left-[100%] top-0 w-fit">
        <div
          ...
          group-hover:visible group-hover:block absolute left-4 whitespace-normal w-[180px] h-auto z-50
...
export function ScoreToolTip ({ children, text }: Props) {
  return (
    <div className="group relative w-fit h-fit">
      {children}
      <div className="absolute -left-[53px] bottom-6">
        <div
          ...
          group-hover:visible group-hover:block absolute whitespace-normal max-w-[250px] h-auto z-50 bottom-0
